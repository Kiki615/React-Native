...
class CampsiteInfo extends Component {
    ...
    //############# What are we doing with CampsiteId as an arguement????

    handleComment(campsiteId){
       // console.log(JSON.stringify(this.state));
        this.props.postComment(campsiteId, this.state.rating, this.state.author, this.state.text);
        this.toggleModal();
        // FIX 1: You do not need a rest here since you are already calling it below in your "onPress" event handlers for your form buttons.
        // this.resetForm();
        // END FIX 1
    }
            ...
            <ScrollView>
                ...
                >
                    ...
                    <View style={{margin: 10}}>
                        <Button
                            onPress={() => {
                                // FIX 2: You need to also toggle the modal when the form submission is cancelled.
                                this.toggleModal();
                                // END FIX 2
                                this.resetForm();
                            }}
